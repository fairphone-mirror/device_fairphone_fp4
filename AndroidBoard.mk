...
TARGET_KERNEL_MAKE_ENV += LD=$(TEMP_TOP)/$(SOONG_LLVM_PREBUILTS_PATH)/ld.lld
TARGET_KERNEL_MAKE_ENV += AR=$(TEMP_TOP)/$(SOONG_LLVM_PREBUILTS_PATH)/llvm-ar
TARGET_KERNEL_MAKE_ENV += NM=$(TEMP_TOP)/$(SOONG_LLVM_PREBUILTS_PATH)/llvm-nm
TARGET_KERNEL_MAKE_ENV += OBJCOPY=$(TEMP_TOP)/$(SOONG_LLVM_PREBUILTS_PATH)/llvm-objcopy
TARGET_KERNEL_MAKE_ENV += OBJDUMP=$(TEMP_TOP)/$(SOONG_LLVM_PREBUILTS_PATH)/llvm-objdump
TARGET_KERNEL_MAKE_ENV += STRIP=$(TEMP_TOP)/$(SOONG_LLVM_PREBUILTS_PATH)/llvm-strip
...
TARGET_KERNEL_MAKE_ENV += DEPMOD=$(HOST_OUT_EXECUTABLES)/depmod$(HOST_EXECUTABLE_SUFFIX)
